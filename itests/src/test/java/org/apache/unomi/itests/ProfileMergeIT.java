...
public class ProfileMergeIT extends BaseIT {
    ...
    public void test() throws InterruptedException {
        ...
        keepTrying("Event with id " + TEST_EVENT_TYPE + " not found in the required time",
                () -> this.eventService.getEvent(TEST_EVENT_TYPE),
                savedEvent -> Objects.nonNull(savedEvent) && Objects.nonNull(savedEvent.getProfile()), DEFAULT_TRYING_TIMEOUT,
